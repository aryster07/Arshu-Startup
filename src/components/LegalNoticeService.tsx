        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center px-6 py-2 bg-slate-900 text-white text-sm rounded-full mb-8">
              ...
              Professional Legal Notice Services
            </div>
            
            <h1 className="text-4xl md:text-6xl font-bold text-slate-900 mb-6 tracking-tight">
              Expert Legal Notice
              <span className="block text-blue-600">Drafting & Service</span>
            </h1>
            
            <p className="text-xl text-slate-600 mb-12 leading-relaxed">
              Professional legal notice services for all types of disputes with expert drafting, 
              proper legal service, and follow-up support to protect your rights and interests.
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-8 mb-16">
              <div className="flex items-center space-x-3 text-slate-700">
                ...
                <span className="font-medium">24-48 Hour Service</span>
              </div>
              <div className="flex items-center space-x-3 text-slate-700">
                <div className="w-10 h-10 bg-green-100 rounded-lg flex items-center justify-center">
                  <Scale className="h-5 w-5 text-green-600" />
                </div>
                <span className="font-medium">Legally Sound Drafting</span>
              </div>
              <div className="flex items-center space-x-3 text-slate-700">
                <div className="w-10 h-10 bg-purple-100 rounded-lg flex items-center justify-center">
                  <CheckCircle className="h-5 w-5 text-purple-600" />
                </div>
                <span className="font-medium">Proper Legal Service</span>
              </div>
            </div>
