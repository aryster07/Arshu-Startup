...
import { Eye, EyeOff, Mail, Lock, User, Phone, AlertCircle, CheckCircle2, Loader2, Scale, Users, Shield, Award } from 'lucide-react';
...
const LawyerAuthPortalPC: React.FC = () => {
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 py-16 text-white">
          ...
          <div className="mb-12">
            <div className="flex items-center space-x-3 mb-4">
              <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center">
                <span className="text-slate-900 text-xl font-bold">LB</span>
              </div>
              <div>
                <h1 className="text-2xl font-bold">LawB</h1>
                <p className="text-slate-300 text-sm">Professional Legal Services</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-12">
            <h2 className="text-4xl font-bold mb-6 leading-tight">
              Elevate Your Legal Practice with Professional Tools
            </h2>
            <p className="text-xl text-slate-300 mb-8 leading-relaxed">
              Join thousands of legal professionals who trust LawB for comprehensive case management, 
              client consultation, and legal document automation.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-slate-300 text-sm">Streamlined workflow for all your legal cases and documentation</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-slate-300 text-sm">Secure client communication and document sharing platform</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-slate-300 text-sm">Built-in compliance tools and legal document templates</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-slate-300 text-sm">Connect with verified legal professionals and experts</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 pt-8 border-t border-slate-700">
            <p className="text-slate-400 text-sm mb-4">Trusted by 10,000+ legal professionals</p>
            <div className="flex items-center space-x-6">
              <div className="text-center">
                <div className="text-2xl font-bold">10K+</div>
                <div className="text-slate-400 text-xs">Active Lawyers</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold">50K+</div>
                <div className="text-slate-400 text-xs">Cases Handled</div>
              </div>
              <div className="text-center">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="grid grid-cols-3 gap-3">
            <button
              ...
              onClick={() => window.location.href = getOAuthUrl('google', 'lawyer')}
            >
              <GoogleIcon />
            </button>
            <button
            ...
            <button
              type="button"
              className="flex justify-center items-center py-3 px-4 border border-gray-300 rounded-xl hover:bg-gray-50 transition-colors"
              onClick={() => window.location.href = getOAuthUrl('apple', 'lawyer')}
            >
              <AppleIcon />
            </button>
          </div>
...
export default LawyerAuthPortalPC;