...
import LawyerAuthPortalPC from './LawyerAuthPortalPC';
...
const LawyerAuthPortal: React.FC = () => {
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm lg:text-base">
              {isLogin 
                ...
                : 'Create your lawyer account to get started with LawB services.'
              }
            </p>
          </div>
...
export default LawyerAuthPortal;