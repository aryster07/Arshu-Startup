                  ...
                  <Card 
                    ...
                    className={`p-4 cursor-pointer transition-all hover:shadow-md ${
                      selectedEmergency === category.id 
                        ? `ring-2 ${
                            category.color === 'red' ? 'ring-red-500 bg-red-50' :
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-3">
                {legalRights.map((right, index) => (
                  <div key={index} className="text-sm">
                    <h4 className="font-medium text-slate-900 mb-1">{right.title}</h4>
            ...
            <Card className="p-6 bg-green-50 border-green-200">
              <div className="text-center">
                ...
                <h3 className="font-semibold text-green-800 mb-2">Average Response Time</h3>
                <p className="text-2xl font-bold text-green-600 mb-2">5 Minutes</p>
                <p className="text-green-700 text-sm">
                  Our emergency legal team typically responds within 5 minutes during business hours 
                  and 15 minutes after hours.
                </p>
              </div>
            </Card>
            ...
            <Card className="p-6 bg-blue-50 border-blue-200">
              ...
              <div className="space-y-2 text-sm text-blue-700">
                <div className="flex items-start space-x-2">
                  ...
                  <span>Immediate acknowledgment of your emergency</span>
                </div>
                <div className="flex items-start space-x-2">
                  ...
                  <span>Quick assessment by our legal expert</span>
                </div>
                <div className="flex items-start space-x-2">
                  ...
                  <span>Immediate guidance and next steps</span>
                </div>
                <div className="flex items-start space-x-2">
                  ...
                  <span>Coordinated legal assistance as needed</span>
                </div>
              </div>
            </Card>
          </div>
