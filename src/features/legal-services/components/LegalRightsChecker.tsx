    ...
    <div className="mt-6">
      <Tabs defaultValue="overview" className="w-full">
        <TabsList className="flex flex-wrap lg:flex-nowrap w-full h-auto gap-2 bg-slate-100 p-2 rounded-xl">
          <TabsTrigger 
            value="overview" 
            className="text-xs lg:text-sm py-3 lg:py-2 px-4 lg:px-6 flex-1 lg:flex-none rounded-lg border-2 border-transparent data-[state=active]:!bg-white data-[state=active]:!text-blue-600 data-[state=active]:!border-blue-400 data-[state=active]:!shadow-lg data-[state=active]:!font-semibold hover:bg-slate-200 transition-all duration-200"
          >
            Overview
          </TabsTrigger>
          <TabsTrigger 
