...
import { useSpeechRecognition, SUPPORTED_LANGUAGES, getLanguageByCode } from '../../../shared/hooks/useSpeechRecognition';
import { useDashboardAnalysis } from '../../../shared/hooks/dashboard/useDashboardAnalysis';
...
export function AnalysisSection({ selectedLanguage, onLanguageChange, isInCard = false }: AnalysisSectionProps) {
  ...
  if (isInCard) {
    // Compact Desktop Layout - 8px Grid System
    return (
      <div className="space-y-4">
        ...
        {/* Compact Input Row - 8px Grid System */}
        ...
        {/* Status Messages - 8px Grid System */}
        {isListening && (
        ...
        {state.nonLegalMessage && (
          <div className="p-4 bg-amber-50 border border-amber-200 rounded-lg">
            ...
            <p className="text-amber-800 text-sm mb-3">{state.nonLegalMessage}</p>
            <Button
              onClick={resetAnalysis}
              variant="outline"
              className="text-sm h-9 px-4 border-amber-300 text-amber-700 hover:bg-amber-100"
            >
              Reset
            </Button>
          </div>
        ...
        {state.briefAnalysis && !state.nonLegalMessage && (
          <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <h4 className="font-medium text-blue-900 mb-3 text-sm">Legal Analysis</h4>
            <p className="text-blue-800 text-sm leading-relaxed mb-4">{state.briefAnalysis}</p>
            ...
            <div className="flex gap-3">
              ...
              <Button
                onClick={resetAnalysis}
                variant="outline"
                className="text-sm h-9 px-4 border-blue-300 text-blue-700 hover:bg-blue-100"
              >
                New Question
              </Button>
            </div>
            ...
            {state.showDetailedAnalysis && (
              <div className="mt-4 pt-4 border-t border-blue-200">
                <h5 className="font-medium text-blue-900 mb-3 text-sm">Detailed Analysis</h5>
                <div className="text-blue-800 text-sm leading-relaxed bg-white p-4 rounded-lg border-l-4 border-blue-400 max-h-48 overflow-y-auto">
