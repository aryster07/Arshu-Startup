      ...
      <div className="h-full flex flex-col">
        ...
        <div className="mb-12">
          ...
          <p className="text-slate-600 text-lg">
            Access comprehensive legal services, track your cases, and get expert guidance from certified professionals.
          </p>
        </div>

        {/* Voice Search Section */}
        <Card className="p-8 mb-12 bg-gradient-to-r from-blue-50 to-slate-50 border-blue-200">
